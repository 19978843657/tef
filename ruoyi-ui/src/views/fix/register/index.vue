  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="ID号" prop="repairNo">
        <el-input v-model="queryParams.repairNo" placeholder="请输入ID号" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="物料号" prop="materialNo">
        <el-input v-model="queryParams.materialNo" placeholder="请输入物料号" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="序列号" prop="sn">
        <el-input v-model="queryParams.sn" placeholder="请输入序列号" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="分类" prop="classification">
        <el-input v-model="queryParams.classification" placeholder="请输入分类" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="损坏日期" prop="brokenDate">
        <el-date-picker clearable size="small" v-model="queryParams.brokenDate" type="date" value-format="yyyy-MM-dd"
          placeholder="选择损坏日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="pm单" prop="pm">
        <el-input v-model="queryParams.pm" placeholder="请输入pm单" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['material:confirm:edit']">修改</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          type="danger"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="400">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['material:confirm:edit']">修改/确认是否有RFID标签</el-button>
          <el-button v-hasPermi="['material:flow:edit']" size="mini" type="text" icon="el-icon-download"
            @click="handleDownload(scope.row)">生成清单</el-button>
          <el-button size="mini" type="text" icon="el-icon-edit" @click="SubmitConfirm(scope.row)"
            v-hasPermi="['material:confirm:scrap']">提交单据</el-button>

          <el-button size="mini" type="text" icon="el-icon-edit" @click="scrap(scope.row)">取消</el-button>
          <!-- <el-button
            size="mini"
            type="text"
            icon="el-icon-delete"
    ...
    <!-- 添加或修改维修单据对话框 -->
    <el-dialog :title="title" :rules="rules" :visible.sync="open" :close-on-click-modal="false" width="600px"
      append-to-body>
        ...
        <div>
          ...
          <el-form-item label="分类" prop="classification">
            <el-select v-model="form.classification" placeholder="请输入分类">
              <el-option v-for="item in option" :label="item" :value="item" :key="item">
              </el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="损坏描述" prop="damageDescription">
            <el-input type="textarea" :rows="3" placeholder="请输入损坏描述" v-model="form.damageDescription">
            </el-input>
          </el-form-item>
    ...
    <el-dialog :visible.sync="download1.open" :close-on-click-modal="false" append-to-body>
      <table class="printTable" ref="pdfFile" style="width: 190mm; height: 125mm; text-align: center; margin: 0 auto"
        ...
        <tbody colspan="8">
          ...
          <tr>
            <td :rowspan="2" colspan="4">
              ...
              {{
                form.brokenDate
                ? form.brokenDate.split(" ").splice(0, 1).join(" ")
                : ""
              }}
            </td>
          </tr>
...
import {
  ...
  getSortNameList,
  ifRfid,
} from "@/api/material/amend/confirm";
...
export default {
  ...
  methods: {
    ...
    SubmitConfirm(row) {
      ...
      submitConfirm(this.subData).then(
        (res) => {

<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['material:new_in:export']"
          type="warning"
          plain
    ...
    <el-table ref="tableRef" v-loading="loading" :data="inList" :row-key="getRowKeys" @selection-change="handleSelectionChange"  height="500px">
      ...
      <el-table-column label="物料详细编码" align="center" prop="materialDetailNo" width="250" :show-overflow-tooltip="true" />
...
<script>
import { finishedList } from '@/api/material/newIn/finished'
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.downloadPost('/material/new_in/export', { materialIds: this.ids }, `新件完成入库导出表${moment(new Date()).format('YYYY-MM-DD_HH_mm_ss')}.xlsx`)

<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="inList"  height="500px">
      ...
      <el-table-col umn label="用户名" align="center" prop="userName" />
      ...
      <el-table-column label="操作" align="center" fixed="right" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            v-hasPermi="['material:new_in:rack']"
            size="mini"
            type="text"
            icon="el-icon-edit"
...
<!--          <StoreSelect v-model="form.storeInfo" />-->
          <el-input v-model="form.storeInfo" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
<script>
import { rackList, rack } from '@/api/material/newIn/rack'

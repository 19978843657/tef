<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['material:return_in:export']"
          type="warning"
          plain
    ...
    <el-table ref="tableRef" v-loading="loading" :data="inList" :row-key="getRowKeys" @selection-change="handleSelectionChange"  height="500px">
      ...
      <!-- <el-table-column label="新件ID" align="center" prop="returnMaterialId" /> -->
...
<script>
import { finishedList } from '@/api/material/returnIn/finished'
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.downloadPost('/material/return_in/export', { materialIds: this.ids }, `返库完成入库导出表${moment(new Date()).format('YYYY-MM-DD_HH_mm_ss')}.xlsx`)

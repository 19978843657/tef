<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['material:put_out:export']"
          type="warning"
          plain
    ...
    <el-table ref="tableRef" v-loading="loading" :data="outList" :row-key="getRowKeys" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出库时间" align="center" prop="outRackDt" width="180" />
      ...
      <el-table-column label="上架时间" align="center" prop="inputRackDt"  />
...
import { list } from '@/api/material/outPut/complete'
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.downloadPost('/material/put_out/export', { materialIds: this.ids }, `出库完成导出表${moment(new Date()).format('YYYY-MM-DD_HH_mm_ss')}.xlsx`)

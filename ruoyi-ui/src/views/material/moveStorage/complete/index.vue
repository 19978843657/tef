<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['material:move_storage:export']"
          type="warning"
          plain
    ...
    <el-table ref="tableRef" v-loading="loading" :data="outList" :row-key="getRowKeys" @selection-change="handleSelectionChange"  height="500px">
      ...
      <el-table-column label="新库位信息" align="center" prop="storeNewInfo" />
      <el-table-column label="历史库位信息" align="center" prop="storeHistoryInfo" width="150" :show-overflow-tooltip="true" />
      <el-table-column label="移库时间" align="center" prop="moveRackDt" width="180" />
...
import { list } from '@/api/material/moveStorage/complete'
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.downloadPost('/material/move_storage/export', { materialIds: this.ids }, `移库完成导出表${moment(new Date()).format('YYYY-MM-DD_HH_mm_ss')}.xlsx`)

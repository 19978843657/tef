<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="inList"  height="500px">
      ...
      <!-- <el-table-column label="新件ID" align="center" prop="repairMaterialId" /> -->
      ...
      <el-table-column label="操作" align="center" fixed="right" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            v-hasPermi="['material:repair:rack']"
            size="mini"
            type="text"
            icon="el-icon-edit"
...
<script>
import { rackList, rack } from '@/api/material/repair/rack'
  ...
  methods: {
    ...
    submitForm() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          if (this.form.repairMaterialId != null) {
